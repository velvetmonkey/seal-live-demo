...
|---|---|---|
| Multi-gate non-bypass | `Host.step_forward_non_bypass` | `Host/Composition.lean:241` |
| Append-only record | `Host.Record.head_after_append` | `Host/Record.lean:56` |
| Tamper-evident record | `Host.Record.tamper_evident` | `Host/Record.lean:66` |
...
| Single-request non-interference | `Host.NonInterference.observe_noninterference` | `Host/NonInterference.lean:164` |
