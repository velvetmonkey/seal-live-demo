...
> **Bundle provenance (2026-07-16 kernel repin).** The kernel was repinned from the
...
> re-capture under `ff1bfd68`** (GitHub Models in the loop) is queued post-merge and
