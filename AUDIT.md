...
```
sha256(seal-gateway/wasm/seal.wasm) = a37901811df4767fd08142243622b8372254e6ec5bd2d3aca18f0e61d0f109af
...
## Re-run the audit
```sh
sha256sum seal-gateway/wasm/seal.wasm pwa/wasm/seal.wasm   # = a3790181 pin
